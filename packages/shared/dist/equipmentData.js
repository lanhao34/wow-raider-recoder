...
exports.findRaid = findRaid;
exports.findBoss = findBoss;
...
function findRaid(raidId) {
    return exports.RAIDS.find(r => r.id === raidId);
}
function findBoss(raidId, bossId) {
    return findRaid(raidId)?.bosses.find(b => b.id === bossId);
}
function findItem(itemId) {
    for (const raid of exports.RAIDS) {
