...
router.post('/', auth_1.requireLeader, (0, express_validator_1.body)('raidKillId').isInt(), (0, express_validator_1.body)('items').isArray({ min: 1 }), (0, express_validator_1.body)('items.*.itemId').notEmpty(), (0, express_validator_1.body)('items.*.itemName').notEmpty(), (0, express_validator_1.body)('items.*.slot').notEmpty(), (0, express_validator_1.body)('items.*.isTier').optional().isBoolean(), async (req, res) => {
